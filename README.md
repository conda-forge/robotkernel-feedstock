...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/robotkernel-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9588&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/robotkernel-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `robotkernel` can be installed with:

```
conda install robotkernel
```

It is possible to list all of the versions of `robotkernel` available on your platform with:
